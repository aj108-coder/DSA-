...
//Free the dynamically allocted array by delete keyword

    delete[] arr; // if we do not delete the dyanamically allocated array leads to memory leakage whcih is bad practise for progrmmer /coder and it has very bad effect on your code
